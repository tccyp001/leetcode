...
public class anotherQueen {
    ...
    private static void solveNQ(int n, int row, int[] queens, ArrayList<String[]> res){
        if(row == n){
    ...
    private static boolean fit(int n, int[] queens, int row, int col){
        int leftTop = col;
        int rightTop = col;
